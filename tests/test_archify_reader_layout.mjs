...
import { ChromeVisualBrowser, findChrome, VISUAL_CHECK_VIEWPORTS } from '../powers/pkstack/skills/archify/upstream/bin/visual-check.mjs';

const tests = path.dirname(fileURLToPath(import.meta.url));
const runtime = path.resolve(tests, '../powers/pkstack/skills/archify/upstream');
