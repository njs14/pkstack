...
current-session proof, but it exercised candidate B and is not proof of candidate D's new native
...
The following commands were rerun for the candidate-D integration before the new bounded campaign
records were added:
