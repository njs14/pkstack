...
The [usage guide](https://github.com/njs14/pkstack/blob/main/powers/pkstack/docs/usage.md#cli-powers-and-project-setup) separates Power
...
run its Power-local setup script from a terminal as documented in [usage](https://github.com/njs14/pkstack/blob/main/powers/pkstack/docs/usage.md),
...
or failed validation leave capture incomplete. See the [planning guide](https://github.com/njs14/pkstack/blob/main/powers/pkstack/docs/usage.md#plan-and-bind-work).
...
ACP host. See [knowledge usage](https://github.com/njs14/pkstack/blob/main/powers/pkstack/docs/usage.md#use-project-knowledge) for runtime and
evidence limits.
