...
node "$ARCHIFY" deliver architecture \
  docs/artifacts/pkstack-architecture.json \
  docs/artifacts/pkstack-architecture.html \
  --repo-root . --quality showcase --json
node "$ARCHIFY" deliver workflow \
  docs/artifacts/pkstack-task-workflow.json \
  docs/artifacts/pkstack-task-workflow.html \
  --quality showcase --json
node "$ARCHIFY" deliver workflow \
  docs/artifacts/pkstack-updater-workflow.json \
  docs/artifacts/pkstack-updater-workflow.html \
  --quality showcase --json
```
