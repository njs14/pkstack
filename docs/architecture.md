...
[`plugin.json`](../powers/pkstack/plugin.json). This document describes runtime boundaries,
...
The [planning guide](../powers/pkstack/docs/usage.md#plan-and-bind-work) describes that checkpoint,
...
for this purpose. See [saved requests in usage](../powers/pkstack/docs/usage.md#save-a-recurring-request-in-kiro)
...
refused before writes; use the [clean reinstall procedure](../powers/pkstack/docs/usage.md#clean-reinstall)
...
[knowledge usage](../powers/pkstack/docs/usage.md#use-project-knowledge) describes the limits.
...
- There is one goal slot, no automatic uninstaller, and no automatic stale-file
  deletion.
- The [dated compatibility evidence](../powers/pkstack/docs/kiro-v3-compatibility.md#support-and-evidence-matrix)
