...
| [Impeccable](https://github.com/pbakaus/impeccable) | `impeccable` | Frontend design, critique, audit, and refinement methods; excludes binary downloads, detector hooks, font data, and live runtime. [Adaptation](pbakaus-impeccable-provenance.md). |
| [OpenAI Codex](https://github.com/openai/codex) | `babysit-pr` | Shared PR supervision through existing GitHub tooling; preserves PKStack's completion, retry, and authorization rules. [Adaptation](openai-babysit-pr-provenance.md). |
...
| --- | --- | --- |
| [`impeccable`](../skills/impeccable/SKILL.md) | [`pbakaus/impeccable`](https://github.com/pbakaus/impeccable/commit/dbdc470e70dbbda69f9b78ee38bc38ea1d3560b9) | [Exact bundle](pbakaus-impeccable-bundle-manifest.json); condensed design methods with no upstream runtime |
| [`babysit-pr`](../skills/babysit-pr/SKILL.md) | [`openai/codex`](https://github.com/openai/codex/commit/9f70e348e0227980de97e361cce830236fb18317) | [Exact bundle](openai-babysit-pr-bundle-manifest.json); current-session supervision with existing GitHub CLI |
| [`archify`](../skills/archify/SKILL.md) | [`tt-a1i/archify`](https://github.com/tt-a1i/archify/commit/2ead014aa8ec91f104cd052f1a6ca82de5e26c31) | [`tt-a1i-archify-bundle-manifest.json`](tt-a1i-archify-bundle-manifest.json); digest-pinned runtime with [documented local runtime patches](tt-a1i-archify-provenance.md) under `skills/archify/upstream/` |
