...
Review of the transition from `bf2448f03686a8348324e4741106697d30a867f9` to
`85db7fd0a8a66d07d984ac6c5f4fbb5063d00357` found only two illustrative
backfill generator-version labels changing from `0.9.2` to `0.9.3`. Historical
transcript backfill and its external agent dependencies remain excluded, so no
Kiro-native Power workflow or project-template adaptation is made.
