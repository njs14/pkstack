...
The PNGs are unmodified 1440×900 light-theme viewer captures from that check,
not canonical diagram-only exports. They retain the viewer controls; use the
HTML for zoom, theme selection, and its own export menu.
...
Inspect the new captures before replacing a PNG preview. A successful render
alone does not establish visual quality or tested product behavior.
