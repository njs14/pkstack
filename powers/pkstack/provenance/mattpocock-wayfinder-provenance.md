...
issues, native blockers, the unclaimed frontier, four ticket types, scope boundaries,
fog graduation, single-ticket resumption, and linked resolution evidence.
...
GitHub Cloud is the sole tracker. The local operations reference is PKStack-authored
guidance based on GitHub's documented Issues, sub-issues, and dependency APIs.
...
installed wrapper and GitHub reference. Registration and structural validation do
not establish live Kiro execution or GitHub mutation results.
