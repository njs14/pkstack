...
are bound by [`mattpocock-grill-with-docs-bundle-manifest.json`](../metadata/mattpocock-grill-with-docs-bundle-manifest.json).

## Source identities

These are the original upstream bytes, not hashes of the adapted local files. The
exhaustive subtree inventory is [`mattpocock-grill-with-docs-source-parity.json`](../metadata/mattpocock-grill-with-docs-source-parity.json).
