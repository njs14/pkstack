...
6. Write one bounded, ignored plan such as `.pkstack/state/feature-plans/<surface>.json`. Its exact
...
9. Run `.pkstack/bin/projectctl feature validate --output json`. Leave the remaining initial
