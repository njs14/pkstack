...
Use `.pkstack/bin/projectctl` for the entire loop. It is the bootstrap-managed
...
and direct the user to `/pkstack-setup`. Do not emulate goal state in prose or
