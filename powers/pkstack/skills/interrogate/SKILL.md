---
name: interrogate
description: Route a high-stakes proposal through the PKStack model council for evidence-bound challenge, without granting reviewers implementation authority.
---
...
Apply the [`pkstack-model-council`](../pkstack-model-council/SKILL.md) workflow when its
