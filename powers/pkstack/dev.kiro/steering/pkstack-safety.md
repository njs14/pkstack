...
Do not clear an active goal, add attempts to an exhausted goal, weaken its verifier, or overwrite conflicting setup files without explicit direction. Report exact commands, evidence, omissions, and remaining limitations.
