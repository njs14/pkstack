...
Git repository, bootstraps PKStack, starts a goal against the unittest command,
and invokes:

```text
/pkstack-verified-goal Repair account identifier normalization. First record the current failing verifier before editing, then repair and rerun until passed.
```
