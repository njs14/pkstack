...
during the September 4, 2026 naming cleanup. OpenAI's built-in image-generation
tool produced the final image on September 5 UTC; no API key was used. The final
PNG is 1983 × 793 pixels (approximately 2.5:1). The generator did not match the
requested 5:1 canvas; the approved smaller display is controlled by the README,
not by stretching or cropping the image. The square mascot below is unchanged.

SHA-256: `dfe5e5c029f15c9113db243b71f896a37003eefc46d8c4615a8be0f0129ee870`.

The final edit used the preceding text-bearing banner as its reference:
...
byte copy of the source artwork.

The final prompt kept the Kiro ghost's minimal two-eye silhouette and purple rounded-square visual
language while turning the ghost body into a warm golden potato with russet eyes and soft lower
lobes. A compact midnight-navy mortarboard with a cyan tassel represents OKF's knowledge role. The
prompt required a compact 1:1 composition, 32-pixel legibility, transparent outer corners, no text,
