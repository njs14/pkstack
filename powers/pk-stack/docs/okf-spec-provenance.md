...
PK-Stack tracks the complete `okf/` tree from
...
explicitly excluded from PK-Stack's runtime. Nothing from the tracked tree is executed or vendored.

The source is licensed under Apache License 2.0. PK-Stack links to it and records Git identities; it
