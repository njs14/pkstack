...
| [reviews/grok-round-1.md](../../../reviews/grok-round-1.md) | GRK-001 through GRK-004 exposed wrapper environment leakage, malformed feature JSON output, operand containment gaps, and missing active-profile attachment. |
| [reviews/grok-round-2.md](../../../reviews/grok-round-2.md) | GRK-011 through GRK-017 extend review to absolute executables, shell-capable read-only profiles, cached setup, reserved readme names, and joined interpreter flags; findings require disposition rather than blind acceptance. |
| [reviews/grok-round-3.md](../../../reviews/grok-round-3.md) | GRK-021 demonstrates generator/loader YAML round-trip failures; bridge argv typing, setup fallback errors, and parent-exit/descendant cleanup limits remain distinct from semantic proof. |
| [reviews/kiro-selected-profile-campaign.md](../../../reviews/kiro-selected-profile-campaign.md) | The bc6e79a-era selected pstack-profile run records concrete permission observations and a 2-of-4 fixture pass, preceding the later bytecode-boundary campaign. |
| [reviews/kiro-final-campaign.md](../../../reviews/kiro-final-campaign.md) | The b39c20a post-CDX-004 campaign supersedes the earlier run for its original acceptance scope; it records selected-profile fail-repair-pass and preservation, not current release proof. |
