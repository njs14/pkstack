...
The catalog now has 52 Poteto/local routes plus 23 curated routes: 75 in the Power and 74
...
The [catalog-documentation follow-up](../../../powers/pkstack/provenance/provenance.md) adds no new skill
...
| --- | --- |
| [powers/pkstack/provenance/provenance.md](../../../powers/pkstack/provenance/provenance.md) | Selected upstream methods are adapted into native Kiro semantics; attribution, source inventories and package boundaries stay separate from runtime acceptance. |
...
| [powers/pkstack/provenance/upstream-skill-parity.md](../../../powers/pkstack/provenance/upstream-skill-parity.md) | Poteto catalog distinguishes direct ports, native replacements and consolidated aliases; make-bot-ui stays excluded and feature batches need not invent a minimum of three records. |
| [powers/pkstack/provenance/humanlayer-skills-provenance.md](../../../powers/pkstack/provenance/humanlayer-skills-provenance.md) | Four portable HumanLayer methods retain bounded outputs and native planning; Claude-specific registration and improve-claude-md stay provenance-only. |
| [powers/pkstack/provenance/mattpocock-writing-for-agents-provenance.md](../../../powers/pkstack/provenance/mattpocock-writing-for-agents-provenance.md) | Agent writing method and skill mechanics are retained; OpenAI-only UI metadata is not shipped as Kiro configuration. |
| [powers/pkstack/provenance/mattpocock-grilling-provenance.md](../../../powers/pkstack/provenance/mattpocock-grilling-provenance.md) | One shared fact-first interview method carries settled constraints into native planning, stops within scope, and defers capture until approval and permitted execution. |
| [powers/pkstack/provenance/mattpocock-grill-me-provenance.md](../../../powers/pkstack/provenance/mattpocock-grill-me-provenance.md) | The focused interview entrypoint reuses grilling rather than duplicating its method; standalone conversation does not automatically authorize file capture. |
| [powers/pkstack/provenance/mattpocock-domain-modeling-provenance.md](../../../powers/pkstack/provenance/mattpocock-domain-modeling-provenance.md) | Domain modeling preserves precise vocabulary, scenarios and selective ADRs; project knowledge is captured idempotently without moving native assets. |
| [powers/pkstack/provenance/mattpocock-grill-with-docs-provenance.md](../../../powers/pkstack/provenance/mattpocock-grill-with-docs-provenance.md) | Grilling owns questions and domain-modeling owns capture within active permissions; native Plan keeps pending understanding conversational. |
| [powers/pkstack/provenance/astral-python-provenance.md](../../../powers/pkstack/provenance/astral-python-provenance.md) | Astral uv/Ruff/ty wrappers compose locked environments, lint/format and type checks, respecting existing toolchains and reviewed pre-uv bootstrap exceptions. |
| [powers/pkstack/provenance/okf-skills-parity.md](../../../powers/pkstack/provenance/okf-skills-parity.md) | OKF methodology is adapted locally; upstream backfill, validator and visualizer are excluded and Google remains the independent format authority. |
| [powers/pkstack/provenance/okf-skills-provenance.md](../../../powers/pkstack/provenance/okf-skills-provenance.md) | Whole-subtree inventories preserve original source identities; later backfill-only changes remain excluded and do not authorize a runnable transcript import. |
| [powers/pkstack/provenance/google-open-knowledge-format-provenance.md](../../../powers/pkstack/provenance/google-open-knowledge-format-provenance.md) | Active canonical source starts at ad30107 with 132 regular blobs and the same normative SPEC.md blob as the frozen copy; fresh genesis preserves the retired source history without asserting a cross-repository transition. |
| [powers/pkstack/provenance/okf-spec-provenance.md](../../../powers/pkstack/provenance/okf-spec-provenance.md) | Historical provenance for the frozen knowledge-catalog/okf source; its accepted identities remain unchanged after retirement. |
| [powers/pkstack/provenance/okf-spec-source-parity.md](../../../powers/pkstack/provenance/okf-spec-source-parity.md) | Historical 129-blob accounting for the retired source; preserved specification, exclusions, and notices do not establish active tracking. |
| [powers/pkstack/provenance/openknowledge-cli-contract-provenance.md](../../../powers/pkstack/provenance/openknowledge-cli-contract-provenance.md) | The OpenKnowledge CLI schema inventory is a retired runtime reference; preserved accepted identities do not make okn an active dependency or fallback. |
...
| [Impeccable provenance](../../../powers/pkstack/provenance/pbakaus-impeccable-provenance.md) | Exact source and bundle identities; frontend design methods without the executable runtime. |
| [PR Babysitter provenance](../../../powers/pkstack/provenance/openai-babysit-pr-provenance.md) | One shared PR method, explicit stop and retry reconciliation, and no automatic GitHub writes. |
