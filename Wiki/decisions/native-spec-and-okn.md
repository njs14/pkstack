...
description: Decision to keep PKStack as a thin workflow and verification seam over native Kiro and OKF.
tags: [pkstack, decision, kiro, okn, okf]
---
...
ranked, bounded, provenance-bearing retrieval is the interface PKStack needs. `okfcli/okf` may be
