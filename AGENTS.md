...
- Keep executable proof in `projectctl` and `Wiki/features/`; keep broader project context in source-controlled OKF material, with bounded Kiro ACP retrieval and local metadata/link validation.
