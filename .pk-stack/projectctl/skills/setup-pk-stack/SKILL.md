...
After a successful bootstrap use `.pk-stack/bin/projectctl`. A root
...
1. Inspect the working tree and existing `.pk-stack/` and `.kiro/` files. Preserve user-authored files and unrelated dirty work.
