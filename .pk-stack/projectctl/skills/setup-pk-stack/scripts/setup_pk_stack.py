...
if not (POWER_ROOT / "src" / "pk_stack").is_dir():
    for ancestor in SCRIPT_PATH.parents:
        cached_controller = ancestor / ".pk-stack" / "projectctl"
...
from pk_stack.branding import DISPLAY_NAME  # noqa: E402
...
from pk_stack.bootstrap import main  # noqa: E402
