...
For PK-Stack's own updater, the set point is that every reviewed upstream pin is current and all
...
Kiro with `maintain-pk-stack` is the actuator. Secretless verification plus the exact-SHA candidate
