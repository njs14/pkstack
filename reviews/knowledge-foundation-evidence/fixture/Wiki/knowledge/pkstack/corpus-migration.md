...
| `Wiki/decisions/native-spec-and-okn.md` | [Native planning and canonical okn](native-spec-and-okn.md) |
...
selected moves and affected links, then migrate only its current useful knowledge. Keep unrelated
edits, original provenance, and historical evidence intact.
