...
# Prototype knowledge validation versus the local-only requirement
...
[`.kiro/specs/knowledge-foundation/requirements.md`](../../../.kiro/specs/knowledge-foundation/requirements.md)
...
From [`powers/pkstack/src/pkstack/knowledge.py`](../../../powers/pkstack/src/pkstack/knowledge.py):
...
- [Native planning and canonical okn](../pkstack/native-spec-and-okn.md) for the accepted runtime
  boundary this observation measures against
