...
`.pkstack/bin/projectctl knowledge search "<specific rationale>" --budget 1200 --output json` query.
...
PKStack's shipped custom-agent profiles set `includeMcpJson: false`. Do not
